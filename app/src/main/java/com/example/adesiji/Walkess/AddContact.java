...
public class AddContact extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                obj.setOnItemClickListener(new OnItemClickListener(){
                        ...
                        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
                                // The information will be generated alt matically
                                // This allow the databundle put into the programe to be auto generated
        ...
        private void addBack(View view) {
                int id = view.getId();
        ...
        public void onClickDogPet(View view) {
                int id = view.getId();

                if (id == R.id.buttonDog_Or_Pet) {
