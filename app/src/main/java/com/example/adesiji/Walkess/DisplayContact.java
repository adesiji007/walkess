...
public class DisplayContact extends AppCompatActivity {
   ...
   protected void onCreate(Bundle savedInstanceState) {
     ...
     // email = (TextView) findViewById(R.id.editTextDate);
      //email = (TextView) findViewById(R.id.editTextTime);
      ...
      if(extras !=null)
      {
         ...
         if(Value>0){
            // The information these area is the view part not the add contact part for the program.
           ...
           //String tim = rs.getString(rs.getColumnIndex(DBHelper.CONTACTS_COLUMN_DATE));
            //String tim = rs.getString(rs.getColumnIndex(DBHelper.CONTACTS_COLUMN_TIME));
...
**/
      ...
      d.setTitle("Are you really really sure");
      d.show();
      ...
      if(extras !=null)
      {
         ...
         if(Value>0){
            if(mydb.updateContact(id_To_Update,name.getText().toString(), phone.getText().toString(), email.getText().toString(), street.getText().toString(), place.getText().toString())){
               ...
               Toast.makeText(getApplicationContext(), "not really Updated", Toast.LENGTH_SHORT).show();
            }
         }
         else{
            if(mydb.insertContact(name.getText().toString(), phone.getText().toString(), email.getText().toString(), street.getText().toString(), place.getText().toString())){
               ...
               Toast.makeText(getApplicationContext(), "not really inserted", Toast.LENGTH_SHORT).show();
            }
            Intent intent = new Intent(getApplicationContext(),MainActivity.class);
            startActivity(intent);
         }
